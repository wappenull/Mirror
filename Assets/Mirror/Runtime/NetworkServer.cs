...
namespace Mirror
{
    ...
    public static class NetworkServer
    {
        ...
        static void OnCommandMessage(NetworkConnection conn, CommandMessage msg)
        {
            ...
            {
                logger.LogWarning("Spawned object not found when handling Command message [netId=" + msg.netId + "]" + $" cmd: {msg.debug}");
                return;
            }
            ...
            using (PooledNetworkReader networkReader = NetworkReaderPool.GetReader(msg.payload))
                identity.HandleCommand(msg.componentIndex, msg.functionHash, networkReader, conn as NetworkConnectionToClient, debugName:msg.debug);
        }
